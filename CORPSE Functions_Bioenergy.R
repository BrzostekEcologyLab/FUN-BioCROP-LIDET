###Python version of Sulman's CORPSE-N code taken from CORPSE_deriv.py

##Big questions:
###where do we input FUN? Inorganic N and plant N uptake?
...
CORPSE <- function(SOM,T,theta,params,claymod=1.0,Litter=FALSE) {
  ...
  ##Update protected carbon ##Somehow I have to account for unprotectedC and chem_types?
